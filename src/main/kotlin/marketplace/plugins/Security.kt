...
fun Application.configureSecurity() {
  ...
  val jwtSecretId = dotenv()["JWT_SECRET_ID"];
  val jwtSecret = SecretManager.getSecret(jwtSecretId)
    ...
    jwt {
      ...
      verifier(
        JWT
          ...
          // private key would make sure that this is the server who signed the token
